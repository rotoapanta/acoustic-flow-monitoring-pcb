...
void __attribute__((picinterrupt(("low_priority")))) low_isr(void){
    ...
    if (INTCONbits.TMR0IF) {
        Atencion_Int_Timer_0();
    }


    if (PIR1bits.TMR2IF) {
        Atencion_Int_Timer_2();
    }
...
void Atencion_Int_Timer_0(void) {
    ...
    temp_num_minutos_t0 = (double)(562*NUM_MINUTOS_T0);
