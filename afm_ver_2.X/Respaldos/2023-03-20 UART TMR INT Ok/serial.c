...
void Inicializar_UART(void) {
     // Configurar el baud rate a 9600, para un reloj de 8 MHz
    SPBRG = 51;
    // Configurar el registro TXSTA (Transmit Status and Control)
    // TXEN = 1 (Transmit Enable),  BRGH = 1 (High Baud Rate Select)
    TXSTA = 0x24;
    // Configurar el registro RCSTA (Receive Status and Control)
    // SPEN = 1 (Serial Port Enable), CREN = 1 (Continuous Receive Enable)
    RCSTA = 0x90;
